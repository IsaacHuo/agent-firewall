...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.AGENT_SHIELD_DEBUG_TELEGRAM_ACCOUNTS)) {
...
function listConfiguredAccountIds(cfg: AgentShieldConfig): string[] {
...
export function listTelegramAccountIds(cfg: AgentShieldConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: AgentShieldConfig): string {
...
function mergeTelegramAccountConfig(cfg: AgentShieldConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: AgentShieldConfig): ResolvedTelegramAccount[] {
